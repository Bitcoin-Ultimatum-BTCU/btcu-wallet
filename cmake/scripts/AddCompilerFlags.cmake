...
function(remove_c_compiler_flags)
	...
	if(NOT "${CMAKE_BUILD_TYPE}" STREQUAL "")
		...
		set(${BUILD_TYPE_FLAGS} ${${BUILD_TYPE_FLAGS}} CACHE STRING "${BUILD_TYPE_FLAGS}" FORCE)
	endif()
endfunction()
...
function(set_optimization_level_for_language LANGUAGE LEVEL)
	...
	set(CMAKE_${LANGUAGE}_FLAGS "${CMAKE_${LANGUAGE}_FLAGS} -O${LEVEL}" CACHE STRING "CMAKE_${LANGUAGE}_FLAGS" FORCE)
endfunction()
