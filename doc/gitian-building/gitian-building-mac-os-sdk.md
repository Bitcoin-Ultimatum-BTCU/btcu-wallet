...
The script [extract-osx-sdk.sh](https://github.com/bitcoin-ultimatum/orion/blob/master/contrib/macdeploy/extract-osx-sdk.sh) automates this. First ensure
...
btcu/contrib/macdeploy/extract-osx-sdk.sh
...
Troubleshooting
---------------
See [README_osx.md](https://github.com/bitcoin-ultimatum/orion/blob/master/doc/README_osx.md) for troubleshooting tips.