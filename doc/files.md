...
btcu.conf           | contains configuration settings for btcud or btcu-qt
btcud.pid           | stores the process id of btcud while running
...
debug.log           | contains debug information and general logging generated by btcud or btcu-qt
