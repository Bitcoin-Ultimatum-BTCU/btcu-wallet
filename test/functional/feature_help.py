...
"""Verify that starting btcu with -h works as expected."""
import subprocess

from test_framework.test_framework import BtcuTestFramework
from test_framework.util import assert_equal

class HelpTest(BtcuTestFramework):
    ...
    def run_test(self):
        self.log.info("Start btcu with -h for help text")
        ...
        self.log.info("Start btcu with -version for version information")
