...
class RawTransactionsTest(BtcuTestFramework):
    ...
    def run_test(self):
        ...
        try:
            ...
            raise AssertionError("Accepted invalid btcu address")
        except JSONRPCException as e:
            assert("changeAddress must be a valid btcu address" in e.error['message'])
