...
/** Amount in BTCU (Can be negative) */
typedef int64_t CAmount;

static const CAmount COIN = 100000000;
static const CAmount CENT = 1000000;

/** No amount larger than this (in BTCU) is valid in a single UTXO.
 *
 * Note that this constant is *not* the total money supply, which in BTCU
