...
#include "qt/btcu/settings/settingsmultisenddialog.h"
#include "qt/btcu/settings/forms/ui_settingsmultisenddialog.h"
#include <QListView>
    ...
    ui(new Ui::SettingsMultisendDialog)
{
    ...
    setCssProperty(ui->labelSubtitleLabel, "text-subtitle");

    ui->lineEditLabel->setPlaceholderText(tr("Enter label to be saved with this address"));
   setCssEditLine(ui->lineEditLabel, true);

    // Address
    ui->labelSubtitleAddress->setText("BTCU address or contact label");
    setCssProperty(ui->labelSubtitleAddress, "text-subtitle");
    ...
    setCssProperty(ui->labelSubtitlePercentage, "text-subtitle");
    ui->lineEditPercentage->setPlaceholderText("10%");
   setCssEditLine(ui->lineEditPercentage, true);
