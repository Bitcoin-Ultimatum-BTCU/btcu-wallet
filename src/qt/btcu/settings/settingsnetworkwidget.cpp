...
#include "qt/btcu/settings/settingsnetworkwidget.h"
#include "qt/btcu/settings/forms/ui_settingsnetworkwidget.h"
#include "optionsmodel.h"
#include "qt/btcu/qtutils.h"

SettingsNetworkWidget::SettingsNetworkWidget(BTCUGUI* _window, QWidget *parent) :
