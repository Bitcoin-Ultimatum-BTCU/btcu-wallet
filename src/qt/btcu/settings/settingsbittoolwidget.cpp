...
#include "qt/btcu/settings/forms/ui_settingsbittoolwidget.h"
...
SettingsBitToolWidget::SettingsBitToolWidget(BTCUGUI* _window, QWidget *parent) :
...
void SettingsBitToolWidget::importAddressFromDecKey(){
    ...
    ui->statusLabel_DEC->setText(tr("Successfully added btcuate key to the wallet"));
}
