...
#include "qt/btcu/coincontrolbtcuwidget.h"
#include "qt/btcu/forms/ui_coincontrolbtcuwidget.h"

CoinControlBTCUWidget::CoinControlBTCUWidget(QWidget *parent) :
    QDialog(parent),
    ui(new Ui::CoinControlBTCUWidget)
{
    ui->setupUi(this);
    ...
    ui->labelTitle->setText("Select BTCU Outputs to Spend");
    ...
    ui->labelTitleAmount->setText("BTCU");
    ...
    ui->labelValueAfter->setText("0.00 BTCU");
    ui->labelValueAmount->setText("0");
    ui->labelValueBytes->setText("0");
    ui->labelValueDust->setText("No");
    ui->labelValueChange->setText("0.00 BTCU");
    ui->labelValueFee->setText("0.00 BTCU");
...
CoinControlBTCUWidget::~CoinControlBTCUWidget()
{
    delete ui;
}
