...
#include "qt/btcu/forms/ui_requestdialog.h"
#include <QListView>
    ...
    ui(new Ui::RequestDialog)
{
    ...
    ui->labelMessage->setText(tr("Instead of sharing only a BTCU address, you can create a payment request, bundling up more information."));
