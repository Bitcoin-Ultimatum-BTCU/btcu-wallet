...
/** Utility functions used by the BTCU Qt UI.
 */
namespace GUIUtil
{
...
// Render BTCU addresses in monospace font
...
// Format an amount
QString formatBalance(CAmount amount, int nDisplayUnit = 0, bool isZbtcu = false);
...
// Parse "btcu:" URI into recipient object, return true on successful parsing
