...
/* Btcu GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "BTCU"
#define QAPP_ORG_DOMAIN "btcu.io"
#define QAPP_APP_NAME_DEFAULT "BTCU-Qt"
#define QAPP_APP_NAME_TESTNET "BTCU-Qt-testnet"
