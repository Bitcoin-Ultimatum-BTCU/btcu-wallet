...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        {"blockchain", "getaccountinfo", &getaccountinfo, true, false, false},
        /* Mining */
        ...
        /* BTCU features */
        {"btcu", "listmasternodes", &listmasternodes, true, true, false},
        {"btcu", "getmasternodecount", &getmasternodecount, true, true, false},
        {"btcu", "masternodeconnect", &masternodeconnect, true, true, false},
        {"btcu", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"btcu", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"btcu", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"btcu", "masternodecurrent", &masternodecurrent, true, true, false},
        ...
        {"btcu", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"btcu", "getmasternodescores", &getmasternodescores, true, true, false},
        {"btcu", "preparebudget", &preparebudget, true, true, false},
        {"btcu", "submitbudget", &submitbudget, true, true, false},
        {"btcu", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"btcu", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"btcu", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"btcu", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"btcu", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"btcu", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"btcu", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"btcu", "checkbudgets", &checkbudgets, true, true, false},
        {"btcu", "mnsync", &mnsync, true, true, false},
        {"btcu", "spork", &spork, true, true, false},
        {"btcu", "getpoolinfo", &getpoolinfo, true, true, false},
        {"btcu", "mnregvalidator", &mnregvalidator, true, true, false},
        {"btcu", "mnregvalidatorlist", &mnregvalidatorlist, true, true, false},
        ...
        {"zerocoin", "getzbtcuseed", &getzbtcuseed, false, false, true},
...
{
    return "> btcu-cli " + methodname + " " + args + "\n";
}
