...
extern UniValue reprocess(const UniValue& params, bool fHelp);
...
extern UniValue setzbtcuseed(const UniValue& params, bool fHelp);
extern UniValue getzbtcuseed(const UniValue& params, bool fHelp);
...
extern UniValue mnping(const UniValue& params, bool fHelp);
...
extern UniValue mnvotevalidator(const UniValue& params, bool fHelp);
