...
::
  cpp-ethereum --download-snapshot SNAPSHOT_DIR -v 9

If it doesn't find the peer to download from, you can also provide the address of a running node with main net snapshot (can be a Parity node or an cpp-ethereum node with imported snapshot)
::
  cpp-ethereum --download-snapshot SNAPSHOT_DIR -v 9 --peerset required:493d52068ec72230688da539926f47a452b762bc348d2ab1491f399b532186d71d7c512e09ffb8e9c24d292d064c00f6234ef1221bc0d86093d2de32358d33da@52.169.85.130:30303 --pin --no-discovery
...
::
  cpp-ethereum --import-snapshot SNAPSHOT_DIR -v 8
