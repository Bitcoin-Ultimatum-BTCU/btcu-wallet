...
void version()
{
    ...
    cout << "cpp-ethereum " << buildinfo->project_version << "\n";
...
//  double blockFees = 15.0;
    ...
    dev::WebThreeDirect web3(WebThreeDirect::composeClientVersion("cpp-ethereum"), db::databasePath(),
