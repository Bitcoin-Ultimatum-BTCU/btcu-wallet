 ...
 * BTCU system. There are three: the main network on which people trade goods
...
public:
    ...
    int BtcuBadBlockTime() const { return nBtcuBadBlockTime; }
    int BtcuBadBlocknBits() const { return nBtcuBadBlocknBits; }
...
protected:
    ...
    int nLastPOWBlock;
    int64_t nBtcuBadBlockTime;
    unsigned int nBtcuBadBlocknBits;
