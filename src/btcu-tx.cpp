...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Btcu Core btcu-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  btcu-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded btcu transaction") + "\n" +
                               "  btcu-tx [options] -create [commands]   " + _("Create hex-encoded btcu transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded btcu transaction
