...
#ifndef BTCU_ZBTCUWALLET_H
#define BTCU_ZBTCUWALLET_H
...
public:
    CzBTCUWallet(std::string strWalletFile);
    ...
    void GenerateDeterministicZBTCU(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedToZBTCU(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);
