...
#ifndef BTCU_ZBTCUTRACKER_H
#define BTCU_ZBTCUTRACKER_H
...
public:
    CzBTCUTracker(std::string strWalletFile);
    ~CzBTCUTracker();
    void Add(const CDeterministicMint& dMint, bool isNew = false, bool isArchived = false, CzBTCUWallet* zBTCUWallet = NULL);
